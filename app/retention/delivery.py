...
from app.retention import telegram_format
from app.retention.telegram_transport import TelegramClient, inline_keyboard
...
class TelegramChannel:
    ...
    async def send_photo(self, ru: dict[str, Any], photo_id: int,
        ...
        from app.retention import retention  # late: retention imports modules that import this one
        if header:
