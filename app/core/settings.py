...
from app.chat import escalation as _escalation
...
def validate_setting(key: str, value: Any) -> dict[str, Any]:
    ...
    if key == "antispam":
        ...
        from app.i18n import language as _language  # lazy: avoid import cycle at module load
...
def global_retention_int(key: str, default: int, lo: int, hi: int) -> int:
    ...
    """
    from app.core import tenancy  # lazy: settings is imported before tenancy in some paths
...
def validate_translations(value: Any) -> dict[str, dict[str, str]]:
    ...
    """
    from app.i18n import language as _language     # lazy: avoid import cycles at module load
