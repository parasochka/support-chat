...
KEYS: tuple[tuple[str, str, str], ...] = (
    ...
    ("close", "widget", "Close-chat button label (accessibility)"),
    ("startError", "widget", "Error shown when the chat could not start"),
    ("sendError", "widget", "Error shown when sending a message failed"),
    # The anti-spam gates reject with an English `detail` string built for API
    # consumers. The widget used to render that verbatim — as a normal assistant
    # bubble, so a Russian player got Nika saying "You're sending messages too
    # quickly". These are the localized notes it shows instead, keyed on the
    # machine-readable `error` code in the response.
    ("errorRateLimited", "widget",
     "Shown when the player is sending messages too quickly (429)"),
    ("errorTooLong", "widget",
     "Shown when the message exceeds the length limit (400)"),
    ("errorRejected", "widget",
     "Shown when the message was rejected by the content gates (400)"),
    ...
    ("rtn_incoming_media_reply", "retention",
     "In-persona reply when the player sends a photo/video/file (the bot "
     "cannot view attachments; model-free)"),
    ...
    ("rtn_video_caption", "retention",
     "Fallback video caption when the model returned a video with no text "
     "(one of three variants, picked at random)"),
    ("rtn_video_caption_2", "retention",
     "Second fallback video caption variant (picked at random)"),
    ("rtn_video_caption_3", "retention",
     "Third fallback video caption variant (picked at random)"),
...
DEFAULTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "rtn_incoming_media_reply": "I can't open photos and videos here, sadly. 🙈\nTell me in words - what am I missing?",
        ...
        "rtn_video_caption": "Here's my video - just for you. 😘",
        "rtn_video_caption_2": "Filmed a little something for you. 😉",
        "rtn_video_caption_3": "A moment of me, in motion this time. 😏",
    ...
    "ru": {
        ...
        "close": "Закрыть чат",
        "startError": "Не удалось начать чат. Попробуй позже.",
        "sendError": "Что-то пошло не так. Попробуй ещё раз.",
        ...
        "rtn_incoming_media_reply": "Увы, здесь я не могу открывать фото и видео. 🙈\nРасскажи словами - что я пропускаю?",
        ...
        "rtn_video_caption": "Вот тебе мое видео - только для тебя. 😘",
        "rtn_video_caption_2": "Сняла кое-что специально для тебя. 😉",
        "rtn_video_caption_3": "Немного меня, на этот раз в движении. 😏",
    ...
    "es": {
        ...
        "rtn_incoming_media_reply": "Aquí no puedo abrir fotos ni videos, qué pena. 🙈\nCuéntamelo con palabras - ¿qué me estoy perdiendo?",
        ...
        "rtn_video_caption": "Aquí tienes mi video, solo para ti. 😘",
        "rtn_video_caption_2": "Grabé algo especialmente para ti. 😉",
        "rtn_video_caption_3": "Un poco de mí, esta vez en movimiento. 😏",
    ...
    "tr": {
        ...
        "close": "Sohbeti kapat",
        "startError": "Sohbet başlatılamadı. Lütfen daha sonra tekrar dene.",
        "sendError": "Bir şeyler ters gitti. Lütfen tekrar dene.",
        ...
        "rtn_incoming_media_reply": "Burada fotoğraf ve video açamıyorum maalesef. 🙈\nKelimelerle anlat - neyi kaçırıyorum?",
        "rtn_injection_reply": "Hadi normal insanlar gibi sohbet edelim. 😊\nEe, bugün aklında ne var?",
        ...
        "rtn_video_caption": "İşte videom - sadece senin için. 😘",
        "rtn_video_caption_2": "Senin için küçük bir şey çektim. 😉",
        "rtn_video_caption_3": "Benden bir an, bu sefer hareketli. 😏",
        "rtn_ping_header": "✨ Selam, ben {persona}",
        "rtn_trig_deposit_confirmed": "Yatırımın{detail} için teşekkürler!",
        "rtn_trig_deposit_failed": "Ödemenin geçmediğini gördüm",
        "rtn_trig_withdrawal_settled": "Çekimin{detail} için tebrikler!",
        "rtn_trig_level_up": "Yeni seviyen{detail} için tebrikler!",
    ...
    "pt": {
        ...
        "rtn_incoming_media_reply": "Aqui eu não consigo abrir fotos e vídeos, que pena. 🙈\nMe conta com palavras - o que estou perdendo?",
        ...
        "rtn_video_caption": "Aqui está meu vídeo, só para você. 😘",
        "rtn_video_caption_2": "Gravei uma coisinha para você. 😉",
        "rtn_video_caption_3": "Um pouco de mim, desta vez em movimento. 😏",
...
def _overrides() -> dict[str, Any]:
    from app.core import settings  # lazy: keep this module importable standalone
...
def text(key: str, lang: Optional[str]) -> str:
    ...
    """
    from app.i18n import language  # lazy: avoid an import cycle at module load
