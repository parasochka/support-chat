...
DEFAULTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "rtn_not_subscribed": "⚠️ I don't see your subscription yet. Subscribe to the channel and tap \"I subscribed\" again.",
    ...
    "ru": {
        ...
        "rtn_not_subscribed": "⚠️ Пока не вижу твою подписку. Подпишись на канал и снова нажми \"Я подписался\".",
        ...
        "rtn_ping_header": "✨ Тебе пишет {persona}",
    ...
    "es": {
        ...
        "rtn_not_subscribed": "⚠️ Aún no veo tu suscripción. Suscríbete al canal y pulsa \"Me suscribí\" otra vez.",
    ...
    "tr": {
        ...
        "rtn_not_subscribed": "⚠️ Aboneliğini henüz göremiyorum. Kanala abone ol ve tekrar \"Abone oldum\" düğmesine bas.",
    ...
    "pt": {
        ...
        "rtn_not_subscribed": "⚠️ Ainda não vejo sua inscrição. Inscreva-se no canal e toque em \"Me inscrevi\" de novo.",
