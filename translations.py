...
DEFAULTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "rtn_menu_greeting": "Hi, {name}! It's {persona} - I'm so glad you made it here. Now we can talk right in Telegram: I'm always around to chat, share what's new and show you a thing or two.",
        "rtn_menu_greeting_noname": "Hi! It's {persona} - I'm so glad you made it here. Now we can talk right in Telegram: I'm always around to chat, share what's new and show you a thing or two.",
        ...
        "rtn_handoff_choice": "Choose what works best for you: message your personal manager right here in Telegram, or go to the site and open the support chat - they'll take care of everything there.",
        "rtn_btn_site_support": "🌐 Support on the site",
        "rtn_nika_start": "Well then, I'm all yours. What are you up to today?",
        "rtn_rate_limited": "Wow, you're fast! Give me a moment to catch my breath - I'll answer in a couple of minutes.",
        ...
        "rtn_ping_header": "✨ A little note from {persona}",
    ...
    "ru": {
        ...
        "rtn_menu_greeting": "Привет, {name}! Это {persona} - как здорово, что ты дошёл сюда. Теперь можно общаться прямо в Telegram: я всегда на связи, поболтаю с тобой, поделюсь новостями и покажу кое-что интересное.",
        "rtn_menu_greeting_noname": "Привет! Это {persona} - как здорово, что ты дошёл сюда. Теперь можно общаться прямо в Telegram: я всегда на связи, поболтаю с тобой, поделюсь новостями и покажу кое-что интересное.",
        ...
        "rtn_handoff_choice": "Выбери, как тебе удобнее: напиши своему персональному менеджеру прямо здесь, в Telegram, или перейди на сайт и открой чат поддержки - там обо всём позаботятся.",
        "rtn_btn_site_support": "🌐 Поддержка на сайте",
        "rtn_nika_start": "Ну что, я вся твоя. Чем занимаешься сегодня?",
        "rtn_rate_limited": "Ого, как ты быстро! Дай мне перевести дух - отвечу через пару минут.",
        ...
        "rtn_ping_header": "✨ Весточка от {persona}",
    ...
    "es": {
        ...
        "rtn_menu_greeting": "¡Hola, {name}! Soy {persona} - me alegra mucho que hayas llegado. Ahora podemos hablar aquí, en Telegram: siempre estoy cerca para charlar, contarte novedades y enseñarte alguna cosita.",
        "rtn_menu_greeting_noname": "¡Hola! Soy {persona} - me alegra mucho que hayas llegado. Ahora podemos hablar aquí, en Telegram: siempre estoy cerca para charlar, contarte novedades y enseñarte alguna cosita.",
        ...
        "rtn_handoff_choice": "Elige lo que te venga mejor: escribe a tu gestor personal aquí mismo, en Telegram, o entra en el sitio y abre el chat de soporte - allí se ocuparán de todo.",
        "rtn_btn_site_support": "🌐 Soporte en el sitio",
        "rtn_nika_start": "Pues aquí me tienes, toda tuya. ¿Qué haces hoy?",
        "rtn_rate_limited": "¡Vaya, qué rápido! Dame un momento para respirar - te contesto en un par de minutos.",
        ...
        "rtn_ping_header": "✨ Una notita de {persona}",
    ...
    "tr": {
        ...
        "rtn_menu_greeting": "Merhaba, {name}! Ben {persona} - buraya gelmene çok sevindim. Artık Telegram'da konuşabiliriz: her zaman buradayım, sohbet ederiz, yenilikleri paylaşırım ve sana bir şeyler gösteririm.",
        "rtn_menu_greeting_noname": "Merhaba! Ben {persona} - buraya gelmene çok sevindim. Artık Telegram'da konuşabiliriz: her zaman buradayım, sohbet ederiz, yenilikleri paylaşırım ve sana bir şeyler gösteririm.",
        ...
        "rtn_handoff_choice": "Sana en uygun olanı seç: kişisel yöneticine buradan, Telegram'dan yaz ya da siteye geç ve destek sohbetini aç - orada her şeyle ilgilenirler.",
        "rtn_btn_site_support": "🌐 Sitedeki destek",
        "rtn_nika_start": "Ee, tamamen seninleyim. Bugün neler yapıyorsun?",
        "rtn_rate_limited": "Vay, ne kadar hızlısın! Bir nefes almama izin ver - birkaç dakika içinde cevap veririm.",
        ...
        "rtn_ping_header": "✨ {persona}'dan küçük bir not",
    ...
    "pt": {
        ...
        "rtn_menu_greeting": "Oi, {name}! Aqui é a {persona} - que bom que você chegou. Agora podemos conversar direto no Telegram: estou sempre por aqui para bater papo, contar novidades e te mostrar umas coisinhas.",
        "rtn_menu_greeting_noname": "Oi! Aqui é a {persona} - que bom que você chegou. Agora podemos conversar direto no Telegram: estou sempre por aqui para bater papo, contar novidades e te mostrar umas coisinhas.",
        ...
        "rtn_handoff_choice": "Escolha o que for melhor para você: mande mensagem para o seu gerente pessoal aqui mesmo, no Telegram, ou vá ao site e abra o chat de suporte - lá vão cuidar de tudo.",
        "rtn_btn_site_support": "🌐 Suporte no site",
        "rtn_nika_start": "Então, sou toda sua. O que está fazendo hoje?",
        "rtn_rate_limited": "Uau, que rapidez! Me dá um instante para respirar - já te respondo em uns minutos.",
        ...
        "rtn_ping_header": "✨ Um recadinho de {persona}",
