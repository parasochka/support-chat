...
KEYS: tuple[tuple[str, str, str], ...] = (
    ...
    ("rtn_photo_caption", "retention",
     ...
     "(one of three variants, picked at random)"),
    ("rtn_photo_caption_2", "retention",
     "Second fallback photo caption variant (picked at random)"),
    ("rtn_photo_caption_3", "retention",
     "Third fallback photo caption variant (picked at random)"),
    ("rtn_ping_header", "retention",
     "Short header line shown in italics above every proactive ping message; "
     "an event reaction appends its occasion phrase (rtn_trig_*) on the SAME "
     "line; keep the {persona} placeholder"),
    ("rtn_trig_deposit_confirmed", "retention",
     "Header occasion phrase after a confirmed deposit; optional {detail} "
     "carries the amount"),
    ("rtn_trig_deposit_failed", "retention",
     "Header occasion phrase after a failed deposit attempt"),
    ("rtn_trig_withdrawal_settled", "retention",
     "Header occasion phrase after a settled withdrawal; optional {detail} "
     "carries the amount"),
    ("rtn_trig_level_up", "retention",
     "Header occasion phrase after a loyalty level-up; optional {detail} "
     "carries the new level"),
    ("rtn_trig_class_up", "retention",
     "Header occasion phrase after a loyalty class-up; optional {detail} "
     "carries the new class"),
    ("rtn_trig_kyc_approved", "retention",
     "Header occasion phrase after account verification is approved"),
    ("rtn_trig_bonus_completed", "retention",
     "Header occasion phrase after a bonus is wagered through; optional "
     "{detail} carries the bonus type"),
    ("rtn_trig_bonus_expired", "retention",
     "Header occasion phrase after a bonus expired unused; optional {detail} "
     "carries the bonus type"),
    ("rtn_trig_session_started", "retention",
     "Header occasion phrase after the player started a play session"),
    ("rtn_trig_session_ended", "retention",
     "Header occasion phrase after the player finished a play session"),
    ("rtn_trig_deposit_initiated", "retention",
     "Header occasion phrase after the player started (not yet confirmed) "
     "a deposit"),
    ("rtn_trig_bonus_granted", "retention",
     "Header occasion phrase after a new bonus was granted; optional "
     "{detail} carries the bonus type"),
    ("rtn_trig_bonus_claimed", "retention",
     "Header occasion phrase after the player claimed a bonus; optional "
     "{detail} carries the bonus type"),
    ("rtn_trig_kyc_started", "retention",
     "Header occasion phrase after the player started account verification"),
    ("rtn_trig_kyc_rejected", "retention",
     "Header occasion phrase after account verification was rejected "
     "(keep it gentle)"),
    ("rtn_trig_xp_granted", "retention",
     "Header occasion phrase after the player earned experience points; "
     "optional {detail} carries the XP amount"),
    ("rtn_trig_downgrade", "retention",
     "Header occasion phrase after the player's loyalty level went down "
     "(keep it tactful)"),
    ("rtn_trig_highlights_pack_opened", "retention",
     "Header occasion phrase after the player opened a highlights pack"),
    ("rtn_trig_highlights_pack_completed", "retention",
     "Header occasion phrase after the player completed a highlights pack"),
    ("rtn_trig_check_in_done", "retention",
     "Header occasion phrase after the player completed a daily check-in"),
    ("rtn_trig_mission_completed", "retention",
     "Header occasion phrase after the player completed a mission; optional "
     "{detail} carries the mission name"),
...
DEFAULTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "rtn_photo_caption_2": "Caught this moment for you. 😉",
        "rtn_photo_caption_3": "So you don't forget what I look like. 😏",
        "rtn_ping_header": "✨ Hey, it's {persona}",
        "rtn_trig_deposit_confirmed": "Thank you for the deposit{detail}!",
        "rtn_trig_deposit_failed": "I saw your payment didn't go through",
        "rtn_trig_withdrawal_settled": "Congrats on your payout{detail}!",
        "rtn_trig_level_up": "Congrats on the new level{detail}!",
        "rtn_trig_class_up": "Congrats, a whole new class{detail}!",
        "rtn_trig_kyc_approved": "Your verification is approved!",
        "rtn_trig_bonus_completed": "Bonus completed{detail}, congrats!",
        "rtn_trig_bonus_expired": "Your bonus{detail} expired unused",
        "rtn_trig_session_started": "Nice to see you back in the game!",
        "rtn_trig_session_ended": "Hope the session went well!",
        "rtn_trig_deposit_initiated": "I see you're topping up",
        "rtn_trig_bonus_granted": "You've got a new bonus{detail}!",
        "rtn_trig_bonus_claimed": "Bonus activated{detail}, enjoy!",
        "rtn_trig_kyc_started": "I see you started verification",
        "rtn_trig_kyc_rejected": "Your verification didn't go through",
        "rtn_trig_xp_granted": "Fresh XP earned{detail}!",
        "rtn_trig_downgrade": "Your level slipped a little",
        "rtn_trig_highlights_pack_opened": "You opened a highlights pack!",
        "rtn_trig_highlights_pack_completed": "Highlights pack completed!",
        "rtn_trig_check_in_done": "Check-in done, nice!",
        "rtn_trig_mission_completed": "Mission completed{detail}, congrats!",
    ...
    "ru": {
        ...
        "rtn_photo_caption_2": "Поймала момент специально для тебя. 😉",
        "rtn_photo_caption_3": "Чтобы ты не забывал, как я выгляжу. 😏",
        "rtn_ping_header": "✨ Привет, это {persona}",
        "rtn_trig_deposit_confirmed": "Спасибо за депозит{detail}!",
        "rtn_trig_deposit_failed": "Видела, что платёж не прошёл",
        "rtn_trig_withdrawal_settled": "Поздравляю с выплатой{detail}!",
        "rtn_trig_level_up": "Поздравляю с новым уровнем{detail}!",
        "rtn_trig_class_up": "Поздравляю, у тебя новый класс{detail}!",
        "rtn_trig_kyc_approved": "Верификация пройдена!",
        "rtn_trig_bonus_completed": "Бонус отыгран{detail}, поздравляю!",
        "rtn_trig_bonus_expired": "Твой бонус{detail} сгорел неиспользованным",
        "rtn_trig_session_started": "Рада видеть тебя снова в игре!",
        "rtn_trig_session_ended": "Надеюсь, сессия удалась!",
        "rtn_trig_deposit_initiated": "Вижу, ты пополняешь счёт",
        "rtn_trig_bonus_granted": "У тебя новый бонус{detail}!",
        "rtn_trig_bonus_claimed": "Бонус активирован{detail}, пользуйся!",
        "rtn_trig_kyc_started": "Вижу, ты проходишь верификацию",
        "rtn_trig_kyc_rejected": "Верификация пока не прошла",
        "rtn_trig_xp_granted": "Свежий опыт начислен{detail}!",
        "rtn_trig_downgrade": "Твой уровень немного просел",
        "rtn_trig_highlights_pack_opened": "Ты открыл пак хайлайтов!",
        "rtn_trig_highlights_pack_completed": "Пак хайлайтов собран!",
        "rtn_trig_check_in_done": "Чек-ин засчитан!",
        "rtn_trig_mission_completed": "Миссия выполнена{detail}, поздравляю!",
    ...
    "es": {
        ...
        "rtn_photo_caption_2": "Capturé este momento para ti. 😉",
        "rtn_photo_caption_3": "Para que no olvides cómo me veo. 😏",
        "rtn_ping_header": "✨ Hola, soy {persona}",
        "rtn_trig_deposit_confirmed": "¡Gracias por el depósito{detail}!",
        "rtn_trig_deposit_failed": "Vi que tu pago no se procesó",
        "rtn_trig_withdrawal_settled": "¡Felicidades por tu retiro{detail}!",
        "rtn_trig_level_up": "¡Felicidades por el nuevo nivel{detail}!",
        "rtn_trig_class_up": "¡Felicidades, una clase nueva{detail}!",
        "rtn_trig_kyc_approved": "¡Tu verificación fue aprobada!",
        "rtn_trig_bonus_completed": "¡Bono completado{detail}, felicidades!",
        "rtn_trig_bonus_expired": "Tu bono{detail} expiró sin usarse",
        "rtn_trig_session_started": "¡Qué bueno verte de vuelta en el juego!",
        "rtn_trig_session_ended": "¡Espero que la sesión haya ido bien!",
        "rtn_trig_deposit_initiated": "Veo que estás haciendo un depósito",
        "rtn_trig_bonus_granted": "¡Tienes un bono nuevo{detail}!",
        "rtn_trig_bonus_claimed": "¡Bono activado{detail}, disfrútalo!",
        "rtn_trig_kyc_started": "Veo que empezaste la verificación",
        "rtn_trig_kyc_rejected": "Tu verificación no fue aprobada esta vez",
        "rtn_trig_xp_granted": "¡XP ganada{detail}!",
        "rtn_trig_downgrade": "Tu nivel bajó un poco",
        "rtn_trig_highlights_pack_opened": "¡Abriste un pack de highlights!",
        "rtn_trig_highlights_pack_completed":
            "¡Pack de highlights completado!",
        "rtn_trig_check_in_done": "¡Check-in hecho!",
        "rtn_trig_mission_completed":
            "¡Misión completada{detail}, felicidades!",
    ...
    "tr": {
        ...
        "rtn_photo_caption_2": "Bu anı senin için yakaladım. 😉",
        "rtn_photo_caption_3": "Nasıl göründüğümü unutma diye. 😏",
        "rtn_ping_header": "✨ Selam, ben {persona}",
        "rtn_trig_deposit_confirmed": "Para yatırdığın için teşekkürler{detail}!",
        "rtn_trig_deposit_failed": "Ödemenin geçmediğini gördüm",
        "rtn_trig_withdrawal_settled": "Çekimin için tebrikler{detail}!",
        "rtn_trig_level_up": "Yeni seviyen için tebrikler{detail}!",
        "rtn_trig_class_up": "Tebrikler, yepyeni bir sınıf{detail}!",
        "rtn_trig_kyc_approved": "Doğrulaman onaylandı!",
        "rtn_trig_bonus_completed": "Bonus tamamlandı{detail}, tebrikler!",
        "rtn_trig_bonus_expired": "Bonusun{detail} kullanılmadan sona erdi",
        "rtn_trig_session_started": "Seni yeniden oyunda görmek güzel!",
        "rtn_trig_session_ended": "Umarım oturum iyi geçmiştir!",
        "rtn_trig_deposit_initiated": "Para yatırmaya başladığını gördüm",
        "rtn_trig_bonus_granted": "Yeni bir bonusun var{detail}!",
        "rtn_trig_bonus_claimed": "Bonus aktif{detail}, keyfini çıkar!",
        "rtn_trig_kyc_started": "Doğrulamaya başladığını gördüm",
        "rtn_trig_kyc_rejected": "Doğrulaman bu sefer geçmedi",
        "rtn_trig_xp_granted": "Yeni XP kazandın{detail}!",
        "rtn_trig_downgrade": "Seviyen biraz düştü",
        "rtn_trig_highlights_pack_opened": "Bir highlights paketi açtın!",
        "rtn_trig_highlights_pack_completed": "Highlights paketi tamamlandı!",
        "rtn_trig_check_in_done": "Check-in tamam!",
        "rtn_trig_mission_completed": "Görev tamamlandı{detail}, tebrikler!",
    ...
    "pt": {
        ...
        "rtn_photo_caption_2": "Guardei esse momento para você. 😉",
        "rtn_photo_caption_3": "Para você não esquecer como eu sou. 😏",
        "rtn_ping_header": "✨ Oi, aqui é a {persona}",
        "rtn_trig_deposit_confirmed": "Obrigada pelo depósito{detail}!",
        "rtn_trig_deposit_failed": "Vi que seu pagamento não passou",
        "rtn_trig_withdrawal_settled": "Parabéns pelo saque{detail}!",
        "rtn_trig_level_up": "Parabéns pelo novo nível{detail}!",
        "rtn_trig_class_up": "Parabéns, uma classe nova{detail}!",
        "rtn_trig_kyc_approved": "Sua verificação foi aprovada!",
        "rtn_trig_bonus_completed": "Bônus concluído{detail}, parabéns!",
        "rtn_trig_bonus_expired": "Seu bônus{detail} expirou sem uso",
        "rtn_trig_session_started": "Que bom te ver de volta no jogo!",
        "rtn_trig_session_ended": "Espero que a sessão tenha sido boa!",
        "rtn_trig_deposit_initiated": "Vi que você está fazendo um depósito",
        "rtn_trig_bonus_granted": "Você tem um bônus novo{detail}!",
        "rtn_trig_bonus_claimed": "Bônus ativado{detail}, aproveite!",
        "rtn_trig_kyc_started": "Vi que você começou a verificação",
        "rtn_trig_kyc_rejected": "Sua verificação não foi aprovada desta vez",
        "rtn_trig_xp_granted": "XP ganho{detail}!",
        "rtn_trig_downgrade": "Seu nível caiu um pouco",
        "rtn_trig_highlights_pack_opened":
            "Você abriu um pack de highlights!",
        "rtn_trig_highlights_pack_completed":
            "Pack de highlights completo!",
        "rtn_trig_check_in_done": "Check-in feito!",
        "rtn_trig_mission_completed": "Missão concluída{detail}, parabéns!",
