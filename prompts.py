...
_SUGGESTIONS_DIRECTIVE = (
    ...
    "ARE in the knowledge base and that open a DIFFERENT, adjacent need — never re-ask "
    "about something you already explained in this reply. They must take the player in a "
    "NEW direction (a related but distinct question that uncovers another need), not keep "
    "exploring the same point you just covered. The third option must "
