...
| `RETENTION_V2_SHOW_TRIGGER` | no | `true` | Default for `retention.v2_show_trigger` — adds a chrome line with the fired trigger («⚡ Trigger: deposit_confirmed») to every proactive message. A testing aid; turn off for production players. |
