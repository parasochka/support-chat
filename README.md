...
- **Admin dashboard** (the React Admin SPA in `admin/`, deployed separately as a
  static site over the `/admin/*` API — see `admin/README.md`) — overview metrics,
  per-topic/-language breakdowns
